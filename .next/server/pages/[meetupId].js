...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://Tauqeer:7WhK0b9qWIlDByJf@cluster0.dmezx.mongodb.net/");
    const db = client.db();
...
var __webpack_exports__ = (__webpack_exec__(9131));
